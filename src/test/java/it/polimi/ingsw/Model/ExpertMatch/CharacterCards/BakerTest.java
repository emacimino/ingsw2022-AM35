...
class BakerTest {
    ...
    public void setTestMatch() {
        Assertions.assertDoesNotThrow(() -> {
            ...
            CharacterCard baker = new Baker(expertMatch.getGame(), "Baker");
            ...
            Assertions.assertNull(expertMatch.getBakerEffect());
    ...
    public void match4player_Test(){
        ...
        Assertions.assertDoesNotThrow( ()->{
            ...
            CharacterCard baker = new Baker(expertMatch4Players.getGame(), "baker");
