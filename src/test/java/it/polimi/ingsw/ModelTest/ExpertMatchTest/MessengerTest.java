...
/**
 * Class that contains the tests for the Messenger character card
 */
class MessengerTest {
    ...
    /**
     * Method that tests 10 times the match and Messenger character card interaction
     */
    @RepeatedTest(10)
    ...
    /**
     * Method that tests 10 times the match and Messenger character card interaction in a 4 player match
     */
    @RepeatedTest(10)
